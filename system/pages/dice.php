                        ...
                        <tbody>
                          ...
                          <tr>
                            <td width="20%"><strong>Sistema</strong></td>
                              <td width="80%">
                                <center>
                                Entre no caminho, espere sua vez até chegar mesa, deixe o item na mesa ao lado do dice. de use e receba um tier de 1 a 10.
                                </center>
                              </td>
                          </tr>
                    ...
                    <div class="TableContentContainer" style="border: 1px solid #5f4d41; position: relative; margin-right: 4px;  background-color: #d4c0a1; padding: 0px;">
                      <table class="TableContent" style="width: 100%; border-collapse: collapse; border: 1px solid #faf0d7;" width="100%">
                        <tbody>
                          ...
                          <tr>
                            <td width="20%"><strong>Como Funciona</strong></td>
                              <td width="80%">
                                <center>
                                Quando o Evento estiver aberto, digite !dice, será removido 600 TCs da sua conta e voce poderá tentar a sorte.
                                </center>
                              </td>
                          </tr>
