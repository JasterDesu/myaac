                        ...
                        <tbody>
                          ...
                          <tr>
                            <td width="20%"><strong>System</strong></td>
                              <td width="80%">
                                <center>
                                You can level up the Fast Attack using the fist, the higher it is, the more speed. You can notice a bigger difference every 10 levels.
                                </center>
                              </td>
                          </tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td width="20%"><strong>Image</strong></td>
                              <td width="80%">
                                <center>
                                <img src="images/events/atk_speed.png" alt="Image" width="200" height="400">
                                </center>
                              </td>
                          </tr>
