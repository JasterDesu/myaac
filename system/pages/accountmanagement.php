...
$errors = array();
	...
	if($action == '') {
		...
		$bkp_coins = getBackupCoins($account_logged->getId());
		...
		if(empty($recovery_key)) {
			$account_registered = '<span style="color: red"><img src="' . $template_path .'/images/vipbenefits/icon_no.png"> Not registered.</span>';
		} else {
			if($config['generate_new_reckey'] && $config['mail_enabled'])
				...
				$account_registered = '<b><span style="color: green"><img src="' . $template_path .'/images/vipbenefits/icon_yes.png"> Registered.</span></b>';
		}
